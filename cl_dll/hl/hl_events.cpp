...
void Game_HookEvents()
{
	...
	gEngfuncs.pfnHookEvent("events/mk23.sc", EV_FireMK23);
	...
	gEngfuncs.pfnHookEvent("events/sawblader.sc", EV_FireSawblader);
	gEngfuncs.pfnHookEvent("events/rpg.sc", EV_FireRpg);
	gEngfuncs.pfnHookEvent("events/grenlauncher.sc", EV_FireGrenadeLauncher);
