...
You can generally check out the commit messages, or look for files marked "Video_X.Y.Z.cpp" inside `dlls`. Each video will link to its respective commit in this repository, or file if that's more appropriate.
